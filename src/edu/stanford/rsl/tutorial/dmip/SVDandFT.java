...
public class SVDandFT {
    ...
    public static void invertSVD(SimpleMatrix A)
    {
        ...
        for(int i = 0; i < Sinv.getRows(); i++){
            if(svd.getS().getElement(i, i)!=0){
            double val = 1.0/svd.getreciprocalS().getElement(i, i);
    ...
    public static void main(String[] args) {
        ...
        String filename = "/proj/i5dmip/eb75ofah/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/yu_fill.jpg";
        ...
        String filenameShepp = "/home/cip/medtech2013/da49qixi/DMIP/Shepp-Logan_Phantom.tif";
